...
//            System.out.println("asistenciasSearch[8]: "+asistenciasSearch[8]);
        ...
        /*
                ...
                JOptionPane.showMessageDialog(null, "Ha ocurrido un error al buscar las asistencias.", "Error", JOptionPane.ERROR_MESSAGE);
                System.out.println(e);
            } catch(Exception e){
                JOptionPane.showMessageDialog(null, "Ingrese un dato válido.", "Error", JOptionPane.ERROR_MESSAGE);
                System.out.println(e);
            }
        */
